...
def _run_cli() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='Example: python max_subarray_dc.py --values="-2,1,-3,4,-1,2,1,-5,4"',
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="Comma-separated daily profit/loss values (use --values=\"-2,1,-3\" format for negative numbers).",
    )
    parser.add_argument(
        "--use-kadane",
        action="store_true",
